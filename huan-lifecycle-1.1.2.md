...
# huan-lifecycle v1.1.2 — corrected per Advisor 02:20 FINAL
...
## 3. Transitions
seed->growing: human-gated, concept+context+audience primitives present
growing->HUAN: hybrid-gated, coherence, 2-way edge rule, audience boundary check, clean analyst re-scan after last surgeon pass
...
Source: huan-spec v1.0.9, huan-analyst v1.2.2
